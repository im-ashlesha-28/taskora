    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-sage-50">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h2 className="text-4xl font-heading font-bold text-sage-900 mb-2">Welcome Back</h2>
          <p className="text-sage-500 font-medium italic">"Continue your mindful journey into productivity." 🌸</p>
        </div>
        ...
        <div className="cozy-card bg-white p-10">
          ...
          <div className="mt-8 text-center">
            <p className="text-sage-500 text-sm font-medium">
              New here?{' '}
              <Link to="/signup" className="text-sage-900 font-bold hover:underline">
                Create an account
              </Link>
            </p>
          </div>
