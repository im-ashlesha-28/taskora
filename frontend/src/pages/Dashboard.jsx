                ...
                <AreaChart data={chartData} margin={{ top: 20, right: 0, left: -20, bottom: 0 }}>
                  <defs>
                    <linearGradient id="colorTasks" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#a3d1a3" stopOpacity={0.4}/>
                      <stop offset="95%" stopColor="#a3d1a3" stopOpacity={0}/>
                    </linearGradient>
                  </defs>
                  ...
                  <Tooltip 
                    contentStyle={{ borderRadius: '24px', border: 'none', background: '#364d36', color: '#fff', boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}
                    itemStyle={{ color: '#fff' }}
                  />
                  <Area type="monotone" dataKey="tasks" stroke="#a3d1a3" strokeWidth={4} fillOpacity={1} fill="url(#colorTasks)" />
                </AreaChart>
              </ResponsiveContainer>
            </div>
          </div>
